...
class FetchJobView extends React.Component {
    ...
    startFetchJob = () => {
        const { running_fetch, fetch_job, fetchPending, fetchSuccess, fetchError, navigation } = this.props
                ...
                <View style={fetch_job_style.viewContainer}>
                    ...
                    {fetch_job_value.details.status == COMPLETED &&
                        <View style={fetch_job_style.bottomView}>
                            ...
                            {influencer.error == null ? <InfluencerListFjView influencers={influencer.influencers} /> :
